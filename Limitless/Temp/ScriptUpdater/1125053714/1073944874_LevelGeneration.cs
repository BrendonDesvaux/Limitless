...
public class LevelGeneration : MonoBehaviour {
	...
	void GenerateMap() {
		...
		//Create a neighbor Terrain to the current Terrain
		TerrainData terrainData = Terrain.activeTerrain.terrainData;
		TerrainData neighborTerrainData = new TerrainData();
		neighborTerrainData.heightmapResolution = terrainData.heightmapResolution;
		neighborTerrainData.size = terrainData.size;
		neighborTerrainData.SetHeights(0, 0, terrainData.GetHeights(0, 0, terrainData.heightmapResolution, terrainData.heightmapResolution));
	}
}