...
public class LevelGeneration : MonoBehaviour {
	...
	void GenerateMap() {
		...
		// Assign terraindata to Neighbors
		TerrainData terrainData = transform.GetComponent<Terrain>().terrainData;
		//rotate 180° terrainData
		terrainData.SetHeights(terrainData.heightmapResolution/2, terrainData.heightmapResolution/2, terrainData.GetHeights(0, 0, terrainData.heightmapResolution, terrainData.heightmapResolution));
		transform.GetComponent<Terrain>().bottomNeighbor.terrainData = terrainData;
		transform.GetComponent<Terrain>().topNeighbor.terrainData = terrainData;
		transform.GetComponent<Terrain>().leftNeighbor.terrainData = terrainData;
		transform.GetComponent<Terrain>().rightNeighbor.terrainData = terrainData;
