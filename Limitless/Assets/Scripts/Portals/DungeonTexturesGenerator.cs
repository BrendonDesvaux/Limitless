...
using UnityEngine;
    ...
    public class DungeonTexturesGenerator : MonoBehaviour
    {
        [SerializeField]
        List<UsedTexture> landMap;
        [SerializeField]
        List<UsedTexture> snowMap;
        [SerializeField]
        List<UsedTexture> desertMap;
        public int chosenBiom;
        private List<List<UsedTexture>> chooseTextures;
        private List<UsedTexture> textures;

        public void Generate()
        {
            chooseTextures = new List<List<UsedTexture>>();
            chooseTextures.Add(landMap);
            chooseTextures.Add(snowMap);
            chooseTextures.Add(desertMap);
            textures = chooseTextures[chosenBiom];
        ...
        public void Clear()
        {
            textures = new List<UsedTexture>();
            Generate();
        }
    }

    [System.Serializable]
    public class UsedTexture
    {
